...
export class TrackingSchemaRefactor1782442364064 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "erp_vehicles" ADD "vin_no" character varying(255) NOT NULL`,
    );
    await queryRunner.query(
    ...
    // 1. Seed default tracking policies
    await queryRunner.query(`
    ...
    // 2. Copy data from old erp_inventory_serials -> erp_inventory_tracking_serials
    await queryRunner.query(`
    ...
    // 3. Copy data from old erp_inventory_lots -> erp_inventory_tracking_lots
    await queryRunner.query(`
    ...
    // 4. Migrate tracking_policy enum -> tracking_policy_id FK
    await queryRunner.query(`
    ...
    // 5. Migrate tracking_category_key -> tracking_category_id FK
    await queryRunner.query(`
          UPDATE "erp_inventory_items" i
